...
public func createModel() -> PTNet {
  ...
  let s1 = PTPlace(named: "w1")
  let w2 = PTPlace(named: "w2")
  let s2 = PTPlace(named: "w2")
  let w3 = PTPlace(named: "w3")
  let s3 = PTPlace(named: "w3")
  ...
  let tw3     = PTTransition(
    ...
    return PTNet(places: [r, p, r, m, w1, s1, w2, s2, w3, s3], transitions: [tpt, tpm, ttm, ts1, ts2, ts3, tw1, tw2, tw3])
}
